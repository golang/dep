...
var pathDeductionFixtures = map[string][]pathDeductionFixture{
	...
	"bitbucket": {
		{
			in:   "bitbucket.org/sdboyer/nobm",
			root: "bitbucket.org/sdboyer/nobm",
			mb: maybeSources{
				maybeHgSource{url: mkurl("https://bitbucket.org/sdboyer/nobm")},
				maybeHgSource{url: mkurl("ssh://hg@bitbucket.org/sdboyer/nobm")},
				maybeHgSource{url: mkurl("http://bitbucket.org/sdboyer/nobm")},
				maybeGitSource{url: mkurl("https://bitbucket.org/sdboyer/nobm")},
				maybeGitSource{url: mkurl("ssh://git@bitbucket.org/sdboyer/nobm")},
				maybeGitSource{url: mkurl("git://bitbucket.org/sdboyer/nobm")},
				maybeGitSource{url: mkurl("http://bitbucket.org/sdboyer/nobm")},
			},
		},
		{
			in:   "bitbucket.org/sdboyer/nobm",
		...
		{
			in:   "https://bitbucket.org/sdboyer/nobm",
			root: "bitbucket.org/sdboyer/nobm",
			mb: maybeSources{
				maybeHgSource{url: mkurl("https://bitbucket.org/sdboyer/nobm")},
				maybeGitSource{url: mkurl("https://bitbucket.org/sdboyer/nobm")},
		...
		{
			in:   "bitbucket.org/sdboyer/nobm.git",
			root: "bitbucket.org/sdboyer/nobm.git",
			mb: maybeSources{
				maybeGitSource{url: mkurl("https://bitbucket.org/sdboyer/nobm.git")},
				maybeGitSource{url: mkurl("ssh://git@bitbucket.org/sdboyer/nobm.git")},
				maybeGitSource{url: mkurl("git://bitbucket.org/sdboyer/nobm.git")},
				maybeGitSource{url: mkurl("http://bitbucket.org/sdboyer/nobm.git")},
			},
		},
		{
			in:   "git@bitbucket.org:sdboyer/nobm.git",
			root: "bitbucket.org/sdboyer/nobm.git",
			mb: maybeSources{
				maybeGitSource{url: mkurl("ssh://git@bitbucket.org/sdboyer/nobm.git")},
			},
		...
		{
			in:   "bitbucket.org/sdboyer/nobm.hg",
			root: "bitbucket.org/sdboyer/nobm.hg",
			mb: maybeSources{
				maybeHgSource{url: mkurl("https://bitbucket.org/sdboyer/nobm.hg")},
				maybeHgSource{url: mkurl("ssh://hg@bitbucket.org/sdboyer/nobm.hg")},
				maybeHgSource{url: mkurl("http://bitbucket.org/sdboyer/nobm.hg")},
			},
		},
		{
			in:   "hg@bitbucket.org:sdboyer/nobm",
			root: "bitbucket.org/sdboyer/nobm",
			mb: maybeSources{
				maybeHgSource{url: mkurl("ssh://hg@bitbucket.org/sdboyer/nobm")},
			},
		...
		{
			in:     "git://bitbucket.org/sdboyer/nobm.hg",
			root:   "bitbucket.org/sdboyer/nobm.hg",
